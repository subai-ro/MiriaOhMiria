...
> **Историческая процедура переноса.** Она была выполнена 2026-08-15.
> V0.0-D.2.3 теперь user-local accepted и frozen после 139 tests и LAW 10/10,
> 19/19, 26/26, 26/26. Git-baseline кандидата уже сохранён; команды создания
> репозитория и тега ниже не являются текущим следующим шагом. Следующий
> допустимый этап — design-first P5 canonical model-backed Nereid cognition.
